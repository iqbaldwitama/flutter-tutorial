                                                                ...
                                                                children: <Widget>[
                                                                    ...
                                                                    Column (
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            Text("Jenjang: ${jenjangSarjana ? "Sarjana" : jenjangDiploma ? "Diploma" : jenjangMagister ? "Magister" : jenjangDoktor ? "Doktor" :"Undefined"}"
                                                                                ),
                                                                            Text("Kelas PBP: " + kelasPBP),
                                                                            Text("Practice Mode: ${_nilaiSwitch ? "Yes" : "No"}"),
                                                                        ],
                                                                    ),
                                                                    SizedBox(height: 20),
                                                                    TextButton(
